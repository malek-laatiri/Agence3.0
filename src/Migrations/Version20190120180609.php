 ...
 */
final class Version20190120180609 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE property ADD category_id INT DEFAULT NULL, ADD file_name VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE property DROP category_id, DROP file_name');
    }
}
